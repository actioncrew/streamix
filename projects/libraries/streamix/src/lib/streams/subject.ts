import { createQueue, createReceiver, createSingleValueBuffer, createSubscription, Operator, pipeStream, Receiver, Stream, StreamMapper, Subscription } from "../abstractions";
...
export function createSubject<T = any>(): Subject<T> {
  ...
  const subject: Subject<T> & { getValue(): Promise<T | undefined>; } = {
    ...
    subscribe,
    pipe: function (this: Subject, ...steps: (Operator | StreamMapper)[]) {
